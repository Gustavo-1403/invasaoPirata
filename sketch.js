...
var engine, world, backgroundImg, waterSound, backgroundMusic, cannonExplosion, risadaSound;
...
function preload() {
  ...
  risadaSound = loadSound("assets/pirate_laugh.mp3");
}
  ...
  if (boats.length > 0) {
    ...
    for (var i = 0; i < boats.length; i++) {
      ...
      if (collision.collided && !boats[i].isBroken) {
        gameOver();
        isGameOver = true;
        if(!estaRindo && !risadaSound.isPlaying()){
          risadaSound.play();
          estaRindo = true;
        }
